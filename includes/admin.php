...
class Survey_Admin {
                ...
                <div class="metabox-holder">
                    ...
                    <div class="postbox">
                        ...
                        <div class="inside">
                            ...
                            <p><strong>Upitnik (srpski):</strong> <code>[feedback_form lang="sr"]</code></p>
                            <p><strong>Upitnik (engleski):</strong> <code>[feedback_form lang="en"]</code></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    public static function feedback_page() {
        ...
        <div class="wrap">
            ...
            <table class="wp-list-table widefat fixed striped">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Očekivanja ispunjena</th>
                        <th>Nivo očekivanja</th>
                        <th>Kvalitet predavanja</th>
                        <th>Kvalitet predavača</th>
                        <th>Primenjivost</th>
                        <th>Literatura</th>
                        <th>Prostorije</th>
                        <th>Ishrana</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $fb->premises; ?>/5</td>
                        <td><?php echo $fb->food; ?>/5</td>
                        <td><?php echo $fb->cooperation; ?>/5</td>
        ...
        jQuery(document).ready(function($) {
            $('.view-details').on('click', function() {
                var id = $(this).data('id');
                // AJAX poziv za učitavanje detalja
                $.ajax({
                    url: ajaxurl,
                    type: 'POST',
                    data: {
    ...
    public static function qr_codes_page() {
        ...
        <div class="wrap">
            ...
            <div class="qr-codes-container">
                ...
                <div class="qr-code-section">
                    <h3>Upitnik o kursu - Engleski</h3>
    ...
    private static function export_registrations_csv() {
        ...
        fputcsv($output, array(
            'ID', 'Ime i prezime', 'Kompanija', 'Adresa', 'Radno mesto',
            'Telefon', 'Mobilni', 'Email', 'Datum unosa'
        ));
    ...
    private static function export_feedback_csv() {
        ...
        // Header
        fputcsv($output, array(
            'ID', 'Očekivanja ispunjena', 'Nivo očekivanja', 'Kvalitet predavanja',
            'Kvalitet predavača', 'Primenjivost', 'Literatura', 'Prostorije', 'Ishrana',
            'Saradnja', 'Napredni STEP7', 'Drugi kursevi', 'Poboljšanja', 'Dodatni komentari', 'Datum'
        ));
